...
func getProbeConfig(id probe.ID, c InstrumentationConfig) (InstrumentationLibrary, bool) {
	libKindID := InstrumentationLibraryID{
	...
	libID := InstrumentationLibraryID{
		InstrumentedPkg: id.InstrumentedPkg,
	...
	return InstrumentationLibrary{}, false
}

func isProbeEnabled(id probe.ID, c InstrumentationConfig) bool {
...
func (m *Manager) applyConfig(c InstrumentationConfig) error {
	if m.td == nil {
